// 37. Evaluate Grades Based on Total Marks and Final Exam
...
function examineGrade(marks, isFinal) {
    if (isFinal) {
        return marks >= 90
    }
...
console.log(examineGrade("78"," "));
console.log(examineGrade("90",""));
console.log(examineGrade("89","true"));
console.log(examineGrade("99","true"));
